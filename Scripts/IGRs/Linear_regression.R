...
up_igr <- read.xlsx('~/Documents/PhD/RNA_IGR/Isolate_Igr_Data/Correct/igrs_all.xlsx', sheet = 1)[,c(1,3, 12:19,21)]
down_igr <- read.xlsx('~/Documents/PhD/RNA_IGR/Isolate_Igr_Data/Correct/igrs_all.xlsx', sheet = 1)[,c(1,2,4:11, 20)]
...
#Write to excel file
write.xlsx(sigtable, '~/Documents/PhD/RNA_IGR/Isolate_Igr_Data/Correct/linearregression_igrRNA_pvalues.xlsx')
